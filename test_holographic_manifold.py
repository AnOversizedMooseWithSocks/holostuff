...
from holographic_symbolic import symbolic_regress
from holographic_manifold import (detect_topology, line_dictionary, manifold_dictionary,
                                   decompose_on_manifold)
