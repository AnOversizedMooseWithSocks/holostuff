...
def test_equilibrium_faculty_through_mind():
    from holographic_equilibrium import _moons
    rng = np.random.default_rng(0)
...
def test_forward_forward_faculty_through_mind():
    from holographic_forward import _blobs
    rng = np.random.default_rng(0)
...
def test_chaos_faculty_through_mind():
    from holographic_chaos import lorenz_trajectory
...
def test_learned_energy_faculty_through_mind():
    from holographic_energy import torus_bump_manifold
